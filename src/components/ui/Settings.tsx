      ...
      <form >
        <div className={classes["settings-input-container"]}>
          <div className={classes["settings-input"]}>
            ...
            <input type="number" id="weidth" onChange={props.widthChnageHandler} value={props.data.width}></input>
          </div>
          <div className={classes["settings-input"]}>
            <label htmlFor="top">Top</label>
            <input type="number" id="top" onChange={props.topChnageHandler} value={props.data.top}></input>
          </div>
          <div className={classes["settings-input"]}>
            <label htmlFor="left">Left</label>
            <input type="number" onChange={props.leftChnageHandler} id="left" value={props.data.left}></input>
          </div>
